...
const SHForm = ({ method, userdetails, setSelectedRole, setSelectedSH, users, setUsers }) => {
                ...
                if (!username || !email || !password) {
                    ...
                    try {
                        ...
                        if (res.status === 200 || res.status === 201) {
                            ...
                            toast.success('SH updated successfully', {
                                position: "top-right",
                                autoClose: 2000,
                                hideProgressBar: false,
                                closeOnClick: true,
    ...
    return (
        <div className="SHFORM h-auto w-full overflow-hidden flex justify-center items-center lg:text-[12px] mt-8">

                ...
                <>
                    ...
                    <div className="Table w-full h-full flex flex-col items-center justify-center whitespace-nowrap  lg:overflow-x-auto border-gray-400 border-y-[1px] bg-white roundedlg:overflow-x-auto lg:text-[12px] ">
                        ...
                        <div className="w-full">
                            <div className="w-1/5 py-2 text-center font-bold whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px]">Company</div>
                            {/* <div className="w-1/5 py-2 text-center font-bold whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px]">Details</div> */}
                            <div className="w-1/5 py-2  text-center font-bold  whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px]">Team Leader</div>
                            ...
                            <div className="w-1/5 py-2 text-center font-bold whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px]">Created At</div>
                        </div>
                        ...
                        {records.map((d) => (
                            <div key={d._id} className="w-full" >
                                ...
                                <div className={d.teamleadername === "unassigned" ? "w-1/5 py-2 text-center whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px] text-red-700" : "w-1/5 py-2 text-center whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px]"} >{d.teamleadername}</div>

                                <div className={d.franchisename === "unassigned" ? "w-1/5 py-2 text-center whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px] text-red-700" : "w-1/5 py-2 text-center whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px]"}>{d.franchisename}</div>

                                <div className={d.status !== "assigned" ? "w-1/5 py-2 text-center whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px] text-red-500" : "w-1/5 py-2 text-center whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px] text-green-500"}>{d.status}</div>


                                <div className="w-1/5 py-2 text-center whitespace-nowrap lg:min-w-[200px] inline-block lg:py-1 border-gray-400 border-y-[1px] ">
